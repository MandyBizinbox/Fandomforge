...
function BasicsStep({ form, update, productTypes, selectedProductTypeId, chooseType, templates, selectedTemplate, chooseTemplate, creators, isAdmin, product }) {
  return <div className="space-y-6"><section className="card space-y-5"><div><div className="overline mb-1">Product basics</div><p className="text-sm text-zinc-500">Choose the template here. Its production specs are loaded into the editable Specs box below.</p></div>
