...
export default function AdminManufacturingRulesUnified({ activeSection = "methods" }) {
  ...
  return <div className="ff-admin-page"><div className="ff-admin-page__inner">
    <div className="ff-admin-page-header"><div><p className="overline mb-2">Admin / Production</p><h1 className="ff-admin-page-title">Manufacturing Rules</h1><p className="ff-admin-page-description">One engine for method behaviour, costing profiles, stocked-colour restrictions and production validation.</p></div><div className="flex gap-2"><Link to="/admin" className="btn-secondary">Back to Admin</Link><button type="button" className="btn-secondary flex items-center gap-2" onClick={load}><RefreshCw size={14} /> Refresh</button></div></div>
