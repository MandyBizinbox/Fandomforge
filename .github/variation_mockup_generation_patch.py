...
# ProductArtworkStudio integration.
...
s = insert_once(s, '  getGroupRepresentativeVariationId,\n', '  getVariationLabel,\n', 'studio variation label import')
...
# ProductBuilder persistence integration. If the earlier patch is already present,
# leave it alone; this makes the automation safe to rerun.
...
# Authenticated upload + backend persistence fixes.
p = Path('frontend/src/components/product-builder/variationMockupGeneration.js')
s = p.read_text()
s = insert_once(s, 'import { assetUrl } from "../../lib/api";', 'import { http, assetUrl } from "../../lib/api";', 'mockup upload import')
